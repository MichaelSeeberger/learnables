class StudentProfilesController < ApplicationController
  ...
  private
    ...
    def student_profile_params
      params.require(:student_profile).permit(:name)
    end

    def create_student_profile_params
      params.require(:student_profile).permit(:name, user_attributes: [:email, :password, :password_confirmation])
    end
end
